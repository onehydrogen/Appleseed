...
def load_github_csv():
    ...
    try:
        ...
        raw_url = "https://github.com/onehydrogen/legislativeanalytics91/blob/main/MyCSVApp/data/legislative_analysis_AR_2025_20250217_111047%20copy.csv"
...
app.layout = html.Div([
    ...
    dbc.Container([
        ...
        html.Div([
            ...
            html.H1(" Legislative Dashboard", className="mb-0"),
